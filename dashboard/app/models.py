...
class UserProfile(models.Model):
    ...
    full_name = models.CharField(
        max_length=255, blank=True, verbose_name="Имя и Фамилия"
    )
    ...
    timezone = models.CharField(
        max_length=100, default="Moscow Time (UTC+3)", verbose_name="Часовой пояс"
    )
    ...
    subscription_plan = models.CharField(
        max_length=20, choices=PLAN_CHOICES, default="Free", verbose_name="Тариф"
    )
    subscription_end_date = models.DateField(
        null=True, blank=True, verbose_name="Дата окончания подписки"
    )
